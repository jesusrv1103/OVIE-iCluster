define(function(){
	return{
        timeLine:{
			...
			layers:'http://189.254.255.113/cgi-bin/mapserv?map=/opt/map/mdm60/iclusterzac_vector.map&'
        },
		sakbe:{
		...
		denue:{
			visibleScale:2.388657133483887, //2.388657133483887
			denueSearchLayerId:'cdenue',
			...
			dataSources:{
					view:{
						url:'http://gaiamapas.inegi.org.mx/mdmSearchEngine/busq-denue/select',
						type: 'POST',
						dataType: "jsonp",
						jsonp:'json.wrf',
						stringify:false,
					...
					download:{
						url:'http://189.254.255.113:8080/mdmservices/denue/list',
						contentType : "application/json; charset=utf-8",
						type: 'POST',
						dataType: "json"
					}
		...
		ecoTool:{
			...
			vars_gs:[
					...
					{type:'GranSector',name:'Todos',title:'Industria manufacturera, Comercio y Servicios privados no financieros',label:'Industria manufacturera, Comercio y Servicios privados no financieros',id:17}
			],
			edos:[
					//{id:'00',label:'Nacional'},
					//{id:'01',label:'Aguascalientes'},  {id:'02',label:'Baja California'},  	{id:'03',label:'Baja California Sur'},  	{id:'04',label:'Campeche'},  	{id:'05',label:'Coahuila de Zaragoza'},  	{id:'06',label:'Colima'},
					//{id:'07',label:'Chiapas'},  	{id:'08',label:'Chihuahua'},  	{id:'09',label:'Distrito Federal'},  	{id:'10',label:'Durango'},  	{id:'11',label:'Guanajuato'},  	{id:'12',label:'Guerrero'},
					//{id:'13',label:'Hidalgo'},  	{id:'14',label:'Jalisco'},  	{id:'15',label:'México'},  	{id:'16',label:'Michoacán de Ocampo'},
					{id:'17',label:'Morelos'}
					//{id:'18',label:'Nayarit'},  	{id:'19',label:'Nuevo León'},  	{id:'20',label:'Oaxaca'},  	{id:'21',label:'Puebla'},  	{id:'22',label:'Querétaro'},  	{id:'23',label:'Quintana Roo'},  	{id:'24',label:'San Luis Potosí'},  	{id:'25',label:'Sinaloa'},  	{id:'26',label:'Sonora'},  	{id:'27',label:'Tabasco'},  	{id:'28',label:'Tamaulipas'},
					//{id:'29',label:'Tlaxcala'},  	{id:'30',label:'Veracruz de Ignacio de la Llave'},  	{id:'31',label:'Yucatán'},  	{id:'32',label:'Zacatecas'}
			],
			vars_vals:{
				var_eco:{
