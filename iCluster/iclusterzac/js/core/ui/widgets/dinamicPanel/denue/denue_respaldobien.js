	...
	var module = 
		   {
			...
			init:function(main){
				...
				var localUrl = require.toUrl("dinamicPanelPath");
					...
					localUrl+='denue/';
					//localUrl+='http://mapserver.inegi.org.mx/denue_mdm/procesaDescarga.do?idSesion=149755819348120360&claveGeoestadistica=17&';
			...
			download:function(){
				...
				mainObj = JSON.stringify(mainObj);
					...
					var mainObj2 = JSON.stringify({resolution:4891.969809375,
									centroid:"POINT(-11370801.744747946 2670773.6698312922)",
									polygon:"POLYGON((-7887719.240473 5212151.985801598,-14853884.249023 5212151.985801598,-14853884.249023 129395.35386098949,-7887719.240473 129395.35386098949,-7887719.240473 5212151.985801598))"});
					...
					var list = data.data.list;
						...
						$('.denue-download-list-item').each(function(){
							$(this).click(function(){
								...
								//var url= http://mapserver.inegi.org.mx/denue_mdm/procesaDescarga.do?idSesion=149755819348120360&claveGeoestadistica=17&;
